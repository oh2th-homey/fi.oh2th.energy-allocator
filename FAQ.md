...
[details="Do I need solar panels or a battery to use this?"]
...
[details="My grid meter doesn't report exported energy - is that a problem?"]
...
[details="Why do I have to manually pick a capability instead of the app finding it automatically?"]
...
[details="What's the difference between 'Device Energy Allocation' and 'Whole House Energy Allocation'?"]
...
[details="What's 'Individual' vs. 'Summary' mode?"]
...
[details="Can I add the same device or counter more than once?"]
...
[details="I picked the wrong device/counter - do I have to delete and re-pair?"]
...
[details="Why don't these numbers show up in Homey's Energy tab?"]
...
[details="A device shows 0 right after I add it, or after changing Settings"]
...
[details="My meter reports in coarse steps (e.g. 0.1 kWh) and I see gaps"]
...
[details="What do 'Grid allocation' and 'Self-sufficiency' mean?"]
...
[details="How do I get notified when the split changes?"]
